...
class Delopay_Settings {

	const OPTION_KEY     = 'delopay_settings';
	...
	public static function all() {
		...
		if ( defined( 'DELOPAY_API_KEY' ) && is_string( DELOPAY_API_KEY ) && '' !== DELOPAY_API_KEY ) {
			$merged['api_key'] = DELOPAY_API_KEY;
		}
		if ( defined( 'DELOPAY_WEBHOOK_SECRET' ) && is_string( DELOPAY_WEBHOOK_SECRET ) && '' !== DELOPAY_WEBHOOK_SECRET ) {
			$merged['webhook_secret'] = DELOPAY_WEBHOOK_SECRET;
		}
		return $merged;
	}
	...
	public static function is_overridden( $key ) {
		if ( 'api_key' === $key ) {
			return defined( 'DELOPAY_API_KEY' ) && is_string( DELOPAY_API_KEY ) && '' !== DELOPAY_API_KEY;
		}
		if ( 'webhook_secret' === $key ) {
			return defined( 'DELOPAY_WEBHOOK_SECRET' ) && is_string( DELOPAY_WEBHOOK_SECRET ) && '' !== DELOPAY_WEBHOOK_SECRET;
		}
		return false;
	}
